...
def main(
    ...
    try:
        ...
        if summary.null_key_count or summary.duplicate_key_count:
            summary.require_valid("candidate ad feedback")
    ...
    task_values.set(key="ad_feedback_delta_version", value=output_version)
    task_values.set(key="ad_feedback_row_count", value=summary.row_count)
    task_values.set(
        key="ad_feedback_content_checksum",
