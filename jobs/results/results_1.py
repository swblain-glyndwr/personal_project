...
logger.info("Writing and read complete: df_pf_long")
...
logger.info("Writing and read complete: df_valid_assignments")
...
logger.info("Writing and read complete: df_page_mapping")
...
logger.info("Writing and read complete: df_screen_mapping")
...
logger.info("Writing and read complete: df_sessions_pages_trimmed")
...
logger.info("Writing and read complete: df_fixed_cells")
