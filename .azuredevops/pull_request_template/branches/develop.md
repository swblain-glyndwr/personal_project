...
- Feature / fix / documentation change:
- Goal of the change:
- Linked work item:
...
- Databricks bundle validation, where relevant:
- DEV or DEV Integration run link, where relevant:
...
- Anything intentionally left for a follow-up story:
