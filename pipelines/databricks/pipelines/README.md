...
Python pipelines that import `next_ads` from its supported package root must
set `root_path: ${workspace.file_path}/src`. Lakeflow adds this root to the
Python import path for pipeline execution. Do not replace it with source-level
