create table {catalog}.{schema}.{client}_nextads_analytics_pctr_predictions (
    ...
    , rundate date
    , constraint pk_{client}_nextads_analytics_pctr_predictions PRIMARY KEY (rundate , account_number , uniqueAdID)
)
