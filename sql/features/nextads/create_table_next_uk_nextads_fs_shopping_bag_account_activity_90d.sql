CREATE TABLE IF NOT EXISTS {catalog}.{schema}.next_uk_nextads_fs_shopping_bag_account_activity_90d (
  ...
  CONSTRAINT pk_nextads_fs_shopping_bag_account_activity_90d PRIMARY KEY (
    account_number,
    reference_date
  )
)
