CREATE TABLE IF NOT EXISTS {catalog}.{schema}.next_uk_nextads_fs_theme_affinity_training_input (
  ...
  CONSTRAINT pk_nextads_fs_theme_affinity_training_input PRIMARY KEY (
    account_number,
    theme,
    reference_date
  )
