create table marketingdata_prod.{schema}.{domain}_nextads_customer_cells_fixed_latest (
  ...
  constraint pk_{domain}_nextads_customer_cells_fixed_latest primary key (
    AccountNumber
    )
)
