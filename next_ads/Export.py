...
def generate_experimentid(
    df: DataFrame,
    experiments: list,
    audience_df: Optional[DataFrame] = None,
    audience_sample: Optional[list] = None,
    audience_split: Optional[list] = None,
) -> DataFrame:
    """Creates ExperimentID entry for NextAds json export
    ...
    audience_sample = audience_sample or []
    ...
    if audience_df is not None:
        ...
        df = df.join(audience_df, on="AccountNumber", how="left")
