...
| `pipelines/databricks/variables/` | Databricks cluster/library variables. | `pipelines/databricks/variables/` | Deployment | Medium | With DAB include-path update. | DAB validate. | Move with resources/jobs or immediately after. |
