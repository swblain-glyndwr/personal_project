...
| [`../architecture/feature_store_flow.md`](../architecture/feature_store_flow.md) | Detailed Feature Store task order plus the current model-consumption and research boundary. |
