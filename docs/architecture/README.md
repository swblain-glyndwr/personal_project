...
| Page | Use it for |
| --- | --- |
| [nextads_model_feature_overview.md](nextads_model_feature_overview.md) | Inclusive guide to the main assignment/delivery route and the in-flight Feature Store/model jobs, including what they consume and produce. |
