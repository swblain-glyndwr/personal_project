...
| Understanding shared scoring inputs and operational Theme Affinity scoring | [Theme Affinity operational flow](theme_affinity_operational_flow.md) for the separate input job, shared scoring, publication and checks |
